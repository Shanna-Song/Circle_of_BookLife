					...
					<div class="pdv_border"
						...
						<div style="padding: 0px">
							<div id="topmenu">
								...
								<a href="qiantai/login.jsp" target="_self">用户登录</a>| 
								<a href="qiantai/reg.jsp" target="_self">用户注册</a>| 
							...
							<div id="menu">
								...
								<div id="mainmenu">
									<ul>
										...
										<li><a href="qiantai/shoppingcar.jsp" target="_self">购物车</a></li>

										<li><a href="qiantai/order.jsp" target="_self">订单</a></li>
										<li><a href="${pageContext.request.contextPath}/UserServlet?action=getUserInfo" target="_self">用户中心</a></li>
			...
			<div id='pdv_3608' class='pdv_class' title=''
				...
				<div id='spdv_3608' class='pdv_top'
					...
					<div class="pdv_border"
						style="margin: 0; padding: 0; height: 100%; border: 0px solid; background:;">
						<div style="padding: 0px">
							<img src="qiantai/images/bookti.jpg" alt="" width="100%" border="0" />
						</div>
					</div>
				</div>
			</div>
			...
			<div id='pdv_3699' class='pdv_class' title=''
				...
				<div id='spdv_3608' class='pdv_top'
					...
					<div class="pdv_border"
						...
						<div
							style="padding: 0px; font: bold 13px/43px 'Microsoft YaHei', 'SimSun', Arial, Sans-Serif;">
