		...
		<tr>
			<td valign="top" bgcolor="#F7F8F9">
				...
				<div align="center">
					...
					<form name="form1" action="${pageContext.request.contextPath}/AdminServlet?action=updateAdmin&id=${admin.id}"
							...
							<tbody style="margin: 0; padding: 0">
								...
								<tr>
									...
									<td class="line_table" align="left" width="55%"><input
										...
										<input type="hidden" name="id" value="${admin.pwd}" />
									</td>
								</tr>
								<tr>
									<td class="line_table" align="center" colspan="8" height="20">
										<input type="submit" onclick="verifyInfo()" value="修改" />
									</td>
								</tr>
							</tbody>
						</table>
