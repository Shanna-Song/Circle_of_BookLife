...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <jsp:include flush="fasle" page="top.jsp"/>
  ...
  <tr  >
    ...
    <div id='pdv_391' class='pdv_class'  title='登录' style='width:681px; height:300px; top:0px; left:0px; z-index:50'>
      <div id='spdv_391' class='pdv_content' style='overflow:hidden;width:100%;height:100%'>
        <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:#fff;">
          <div style="height:25px;margin:1px;display:none;background:;">
            <div style="float:left;margin-left:12px;line-height:25px;font-weight:bold;color:"> 用户登录 </div>
          ...
          <div style="padding:0px">
            <div style="width:600px; height:210px;text-align:left;border:1px #f59d5e solid; background-color:#fdebd5;padding:30px;margin:0px">
              <div style="width:210px;float:left;text-align:left;border:1px #f59d5e solid;padding:20px;background-color:#ffffff;">
                <form method="post" action="${pageContext.request.contextPath}/UserServlet?action=login" name="form1" onsubmit="return verifyLogin()">
                  ...
                  <table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td height="40" ><input name="imageField" type="image" src="qiantai/images/denglu.gif"  border="0" />
                        <a href="reg.jsp" style="padding-left:1px"><img src="qiantai/images/zhuce.gif" alt="" width="40" height="19" border="0" /></a></td>
                    </tr>
                  </table>
                </form>
              </div>
              <div style="width:290px;padding:20px;float:right;text-align:left;border:1px #f59d5e solid;background-color:#ffffff;">
                <ul style="margin:0px;padding:0px">
                  <li style=" list-style-type: none;line-height:30px; background:url(qiantai/images/cateitems0.gif) left no-repeat;padding-left:20px"> 如果您已有账号，请在左侧登录 </li>
                  <li style="list-style-type: none;line-height:30px; background:url(qiantai/images/cateitems0.gif) left no-repeat;padding-left:20px"> 如果您还没有注册，<a href="qiantai/reg.jsp" target="_self"><font color="#FF6600">点这里注册账号</font></a></li>
