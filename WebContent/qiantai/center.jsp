...
<script type="text/javascript">
	function verifyInfo() {
		...
		//年龄
		if(!verifyAge(document.form1.age.value)) {
			alert("请按要求输入年龄");
			return false;
		}
		//身份证号
		if(!verifyID(document.form1.card.value)) {
			alert("请按要求输入身份证号");
			return false;
		}
		//家庭地址
		if(!verifyNotNull(document.form1.address.value)) {
			alert("家庭住址不能为空");
			return false;
		}
		//电话号码
		...
		//邮政编码
		if(!verifyPostcode(document.form1.code.value)) {
			alert("请按要求输入邮政编码");
			return false;
		}
	}
	...
	<table width="900" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="center" valign="center" height="450">
				...
				<form action="${pageContext.request.contextPath}/UserServlet?action=updateUserInfo&id=${user.id}" name="form1" method="post"
						...
						<table border="1" cellspacing="0" bordercolorlight="#C0C0C0"
							...
							<tr>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="right"><font color="#996633">用 户
										名：</font></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red"><input class="input7"
									type="text" name="name" value="${user.name}" /></font>
								</td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
							...
							<tr>
								...
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									...
									<font color="red"><input class="input7" type="text"
									name="sex" value="${user.sex}" /></font> 
								</td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">&nbsp;*
								</font>请填写您的真实信息</td>
							...
							<tr>
								...
								<td colspan="3" align="center" bordercolorlight="#C0C0C0"
									...
									value="修改" onclick="verifyInfo()"/></td>
							</tr>
						</table>
					</div>
				</form>
